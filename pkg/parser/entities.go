...
func ParseLine(r *Reader, dxf *drawing.Dxf) error {
	...
	if ParseAcDbEntity(r, line.Entity) != nil || r.AssertNextLine("AcDbLine") != nil {
		return r.Err()
	}
...
func ParsePolyline(r *Reader, dxf *drawing.Dxf) error {
	...
	if ParseAcDbEntity(r, polyline.Entity) != nil || r.AssertNextLine("AcDbPolyline") != nil {
		return r.Err()
	}
...
func ParseArc(r *Reader, dxf *drawing.Dxf) error {
	...
	if ParseAcDbEntity(r, arc.Entity) != nil || r.AssertNextLine("AcDbCircle") != nil {
		return r.Err()
	}
...
func ParseCircle(r *Reader, dxf *drawing.Dxf) error {
	...
	if ParseAcDbEntity(r, circle.Entity) != nil || r.AssertNextLine("AcDbCircle") != nil {
		return r.Err()
	}
...
func ParseText(r *Reader, dxf *drawing.Dxf) error {
	...
	if ParseAcDbEntity(r, text.Entity) != nil || r.AssertNextLine("AcDbText") != nil {
		return r.Err()
	}
...
func ParseMText(r *Reader, dxf *drawing.Dxf) error {
	...
	if ParseAcDbEntity(r, mText.Entity) != nil || r.AssertNextLine("AcDbMText") != nil {
		return r.Err()
	}
...
func ParseHatch(r *Reader, dxf *drawing.Dxf) error {
	hatch := entity.NewMText() // TODO: hatch

	if ParseAcDbEntity(r, hatch.Entity) != nil || r.AssertNextLine("AcDbHatch") != nil {
		return r.Err()
	}
...
func ParseEllipse(r *Reader, dxf *drawing.Dxf) error {
	ellipse := entity.NewMText() // TODO: ellipse

	if ParseAcDbEntity(r, ellipse.Entity) != nil || r.AssertNextLine("AcDbEllipse") != nil {
		return r.Err()
	}
...
func ParsePoint(r *Reader, dxf *drawing.Dxf) error {
	point := entity.NewMText() // TODO: point

	if ParseAcDbEntity(r, point.Entity) != nil || r.AssertNextLine("AcDbPoint") != nil {
		return r.Err()
	}
